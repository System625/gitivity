  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <div className="space-y-8">
        ...
        {/* Philosophy Section */}
        <div className="bg-[#2d314e] rounded-lg border border-white/10 p-8">
          <h2 className="text-2xl font-bold text-white mb-4">The Math</h2>
        ...
        <div className="space-y-6">
          ...
          {/* Creator Score */}
          <div className="bg-[#2d314e] rounded-lg border border-white/10 p-6">
          ...
          <div className="bg-[#2d314e] rounded-lg border border-white/10 p-6">
            <div className="flex items-center gap-3 mb-4">
              <span className="text-2xl">🤝</span>
              <h3 className="text-2xl font-bold text-white">Collaborator</h3>
          ...
          <div className="bg-[#2d314e] rounded-lg border border-white/10 p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-2xl font-bold text-white">Craftsmanship</h3>
        ...
        <div className="bg-red-900/20 rounded-lg border border-red-500/30 p-6">
          <h3 className="text-xl font-bold text-white mb-4">Reality Check</h3>
        ...
        {/* No BS Disclaimer */}
        <div className="text-center bg-gray-900/50 rounded-lg p-6 border border-gray-600">
          <h3 className="text-lg font-semibold mb-2 text-white">No Bullshit Disclaimer</h3>
