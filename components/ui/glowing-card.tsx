  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 text-center max-w-7xl">
        ...
        {showAvailability && (
          <div className="available-now text-green-400 text-sm flex items-center justify-center mt-5">
            <div className="w-2 h-2 bg-green-400 rounded-full inline-block mr-2 animate-pulse shadow-[0_0_8px_rgb(74,222,128)]" />
            Call Now
          </div>
        )}
